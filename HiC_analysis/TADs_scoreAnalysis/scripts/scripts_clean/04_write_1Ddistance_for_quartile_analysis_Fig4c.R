...
print(head(data))
outFileAll <- paste0("1Ddistances_trans1Dinterval_all_domains_vs_all_domains_complete.tab")
write.table(data, file = outFileAll, row.names = F, sep = "\t", append = F, quote = F, col.names = T)
outFileAll <- paste0("1Ddistances_trans1Dinterval_all_domains_vs_all_domains.tab")
...
for(s1 in states)
{
	...
	outFile <- paste0("1Ddistances_trans1Dinterval_all_domains_vs_all_domains_",statePair,"_data.tab")
